...
This PsychoPy experiment is designed to present numbers (1–10) in five randomised blocks and transmit real-time event markers via Lab Streaming Layer (LSL) to an EEG acquisition pipeline.
